 ...
 */
final class Version20220928181303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alergenos (id INT AUTO_INCREMENT NOT NULL, alergenos VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categoria (id INT AUTO_INCREMENT NOT NULL, categoria VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE direccion (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, provincia_id INT NOT NULL, municipio_id INT NOT NULL, calle VARCHAR(255) DEFAULT NULL, numero VARCHAR(255) DEFAULT NULL, puerta_piso_escalera VARCHAR(255) DEFAULT NULL, cod_postal INT NOT NULL, INDEX IDX_F384BE95DE734E51 (cliente_id), UNIQUE INDEX UNIQ_F384BE954E7121AF (provincia_id), UNIQUE INDEX UNIQ_F384BE9558BC1BE0 (municipio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE estado (id INT AUTO_INCREMENT NOT NULL, estado VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE horario (id INT AUTO_INCREMENT NOT NULL, restaurante_id INT NOT NULL, dia INT DEFAULT NULL, apertura TIME DEFAULT NULL, cierre TIME DEFAULT NULL, INDEX IDX_E25853A338B81E49 (restaurante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pedido (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, direccion_id INT NOT NULL, estado_id INT NOT NULL, restaurante_id INT NOT NULL, platos_id INT NOT NULL, total INT DEFAULT NULL, fecha_entrega DATETIME DEFAULT NULL, INDEX IDX_C4EC16CEDE734E51 (cliente_id), UNIQUE INDEX UNIQ_C4EC16CED0A7BD7 (direccion_id), INDEX IDX_C4EC16CE9F5A440B (estado_id), INDEX IDX_C4EC16CE38B81E49 (restaurante_id), INDEX IDX_C4EC16CED77499C5 (platos_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE plato (id INT AUTO_INCREMENT NOT NULL, restaurante_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, imagen_url VARCHAR(255) DEFAULT NULL, precio INT NOT NULL, cantidad INT NOT NULL, INDEX IDX_914B3E4538B81E49 (restaurante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE restaurante (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, logo_url VARCHAR(255) DEFAULT NULL, imagen_url VARCHAR(255) DEFAULT NULL, descripcion VARCHAR(255) DEFAULT NULL, destacado TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cliente CHANGE apellidos apellidos VARCHAR(255) DEFAULT NULL, CHANGE telefono telefono INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cliente CHANGE apellidos apellidos VARCHAR(255) NOT NULL, CHANGE telefono telefono INT NOT NULL');
        $this->addSql('ALTER TABLE municipios CHANGE municipio municipio VARCHAR(255) DEFAULT NULL');
    }
}
